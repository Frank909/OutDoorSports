...
public interface Views {
	...
	public static final String VIEW_DETTAGLI_ESCURSIONI_SISTEMA = "VIEW_DETTAGLI_ESCURSIONI_SISTEMA";
	...
	public static final String VIEW_ISCRITTI_ESCURSIONE_SISTEMA = "VIEW_ISCRITTI_ESCURSIONE_SISTEMA";
	public static final String VIEW_DETTAGLI_PARTECIPANTE_SISTEMA = "VIEW_DETTAGLI_PARTECIPANTE_SISTEMA";
	public static final String VIEW_SELEZIONA_OPTIONAL_ISCRIZIONE_PARTECIPANTE = "VIEW_SELEZIONA_OPTIONAL_ISCRIZIONE_PARTECIPANTE";
	public static final String VIEW_MODIFICA_ISCRIZIONE_ESCURSIONE_PARTECIPANTE = "VIEW_MODIFICA_ISCRIZIONE_ESCURSIONE_PARTECIPANTE";
	public static final String VIEW_SELEZIONA_MODIFICA_OPTIONAL_ISCRIZIONE_PARTECIPANTE = "VIEW_SELEZIONA_MODIFICA_OPTIONAL_ISCRIZIONE_PARTECIPANTE";
}
