...
public class ViewCache {
	...
	private final static String VIEW_LOGIN = "../../../resources/fxml/application/login";
	private final static String VIEW_MANAGER_DI_SISTEMA_CONFIG = "../../../resources/fxml/manager_sistema/managerDiSistemaConfig";
	private final static String VIEW_DASHBOARD_MANAGER_DI_SISTEMA = "../../../resources/fxml/manager_sistema/dashboardManagerSistema";
	private final static String VIEW_DASHBOARD_MANAGER_DI_ESCURSIONE = "../../../resources/fxml/manager_escursione/dashboardManagerEscursione";
	private final static String VIEW_DASHBOARD_PARTECIPANTE = "../../../resources/fxml/partecipante/dashboardPartecipante";
	private final static String VIEW_PASSWORD_DIMENTICATA = "../../../resources/fxml/application/passwordDimenticata";
	private final static String VIEW_REGISTRAZIONE_PARTECIPANTE = "../../../resources/fxml/partecipante/registrazionePartecipante";
	private final static String VIEW_GESTIONE_MANAGER_ESCURSIONE = "../../../resources/fxml/manager_sistema/gestioneManagerEscursione";
	private final static String VIEW_VISUALIZZA_ESCURSIONI_SISTEMA = "../../../resources/fxml/manager_sistema/visualizzaEscursioniSistema";
	private final static String VIEW_REGISTRAZIONE_MANAGER_ESCURSIONE = "../../../resources/fxml/manager_sistema/registrazioneManagerEscursione";
	...
	public void initialize() throws Exception{
		...
		loadForm("VIEW_DASHBOARD_MANAGER_DI_SISTEMA",VIEW_DASHBOARD_MANAGER_DI_SISTEMA); //problema dashboard manager sistema LoadException
